...
do
    ...
    python3 -u run_longExp.py \
        ...
        --c_out 321 \
        --des 'Exp' \
        --itr ${itr} >logs/LongForecasting/$model_name'_electricity_'$pred_len.log
    ...
    python3 -u run_longExp.py \
        ...
        --c_out 7 \
        --des 'Exp' \
        --itr ${itr}  >logs/LongForecasting/$model_name'_Etth1_'$pred_len.log 
    ...
    python3 -u run_longExp.py \
        ...
        --c_out 7 \
        --des 'Exp' \
        --itr ${itr}  >logs/LongForecasting/$model_name'_Etth2_'$pred_len.log 
    ...
    python3 -u run_longExp.py \
        ...
        --c_out 7 \
        --des 'Exp' \
        --itr ${itr}  >logs/LongForecasting/$model_name'_Ettm1_'$pred_len.log 
    ...
    python3 -u run_longExp.py \
        ...
        --c_out 7 \
        --des 'Exp' \
        --itr ${itr}  >logs/LongForecasting/$model_name'_Ettm2_'$pred_len.log 
done
...
do
    python3 -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr ${itr} >logs/LongForecasting/$model_name'_ili_'$pred_len.log
done
